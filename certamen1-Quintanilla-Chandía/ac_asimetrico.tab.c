...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DEFINIR_VECINO = 5,             /* DEFINIR_VECINO  */
  YYSYMBOL_CONECTAR_AUTOMATAS = 6,         /* CONECTAR_AUTOMATAS  */
  YYSYMBOL_AJUSTAR_TASAS = 7,              /* AJUSTAR_TASAS  */
  YYSYMBOL_AVANZAR_PASO = 8,               /* AVANZAR_PASO  */
...
static const char *const yytname[] =
{
  ...
  "CREAR_CELDA", "DEFINIR_VECINO", "CONECTAR_AUTOMATAS", "AJUSTAR_TASAS",
  "AVANZAR_PASO", "NUMERO", "REAL", "';'", "$accept", "programa",
...
{
      -3,    -2,    -1,     0,     1,    -4,     2,    12,     3,    -5,
       4,     6,     7,     8,    10,    -5,    -3,    11,    13,    14,
      -5,    -5,    -5,    15,    16,    17,    -5,    18,    19,    -5,
      20,    -5
};
...
{
       1,     2,     3,     4,     5,     6,    13,     9,    10,    11,
      12,    14,    15,    17,    16,    18,    19,     0,    20,    21,
      23,    22,    24,    25,    26,    27,    28,    29,    30,    31
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     7,     8,    10,     9,     9,     9,
       9,     9,     0,     9,    11,     9,     9,    -1,    10,     9,
...
{
       0,     3,     4,     5,     6,     7,     8,    13,    14,     9,
       9,     9,     9,    10,     9,     0,    11,     9,     9,     9,
      10,     9,    13,     9,     9,     9,     9,     9,     9,     9,
       9,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* instruccion: CREAR_AUTOMATA NUMERO  */
#line 76 "ac_asimetrico.y"
                          {
        crear_automata((yyvsp[0].entero));
    }
#line 1133 "ac_asimetrico.tab.c"
    break;

  case 5: /* instruccion: CREAR_CELDA NUMERO NUMERO NUMERO NUMERO  */
#line 79 "ac_asimetrico.y"
                                              {
        crear_celda((yyvsp[-3].entero), (yyvsp[-2].entero), (yyvsp[-1].entero), (yyvsp[0].entero));
    }
#line 1141 "ac_asimetrico.tab.c"
    break;

  case 6: /* instruccion: DEFINIR_VECINO NUMERO NUMERO NUMERO NUMERO NUMERO  */
#line 82 "ac_asimetrico.y"
                                                        {
        definir_vecino((yyvsp[-4].entero), (yyvsp[-3].entero), (yyvsp[-2].entero), (yyvsp[-1].entero), (yyvsp[0].entero));
    }
#line 1149 "ac_asimetrico.tab.c"
    break;

  case 7: /* instruccion: CONECTAR_AUTOMATAS NUMERO NUMERO NUMERO NUMERO NUMERO NUMERO  */
#line 85 "ac_asimetrico.y"
                                                                   {
        conectar_automatas((yyvsp[-5].entero), (yyvsp[-4].entero), (yyvsp[-3].entero), (yyvsp[-2].entero), (yyvsp[-1].entero), (yyvsp[0].entero));
    }
#line 1157 "ac_asimetrico.tab.c"
    break;

  case 8: /* instruccion: AJUSTAR_TASAS REAL REAL  */
#line 88 "ac_asimetrico.y"
                              {
        ajustar_tasas((yyvsp[-1].real), (yyvsp[0].real));
    }
#line 1165 "ac_asimetrico.tab.c"
    break;

  case 9: /* instruccion: AVANZAR_PASO NUMERO NUMERO  */
#line 91 "ac_asimetrico.y"
                                 {
        avanzar_paso((yyvsp[-1].entero), (yyvsp[0].entero));
    }
#line 1173 "ac_asimetrico.tab.c"
    break;


#line 1177 "ac_asimetrico.tab.c"
